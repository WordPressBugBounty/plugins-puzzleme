...
PuzzleMe's WordPress plugin is free to use. Please visit our <a href="https://amuselabs.com/pricing" target="_blank">pricing page</a> for subscription plans and feature availability.

= What if I have other questions about PuzzleMe? =

Please <a href="https://amuselabs.com/contact-us" target="_blank">contact us</a>.


## Privacy Policy 
PuzzleMe - Interactive Puzzles for WordPress - Easily publish crosswords, quizzes, word searches and more uses [Appsero](https://appsero.com) SDK to collect some telemetry data upon user's confirmation. This helps us to troubleshoot problems faster & make product improvements.
